...
export function ApplicationProvider({ children }) {
  ...
  const fetchApplications = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.DOMAIN}/api/applications/get-all-applications`, {
        method: "GET",
        headers: {
  ...
  const addApplication = async (applicationData) => {
    try {
      const response = await fetch(`${import.meta.env.DOMAIN}/api/applications`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const updateApplication = async (id, applicationData) => {
    try {
      const response = await fetch(`${import.meta.env.DOMAIN}/api/applications/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
