...
export function ApplicationProvider({ children }) {
  ...
  const fetchApplications = async () => {
    setLoading(true);
    try {
      const response = await fetch(`${import.meta.env.VITE_DOMAIN}/api/applications/get-all-applications`, {
        method: "GET",
        headers: {
  ...
  const updateApplication = async (id, applicationData) => {
    try {
      const response = await fetch(`${import.meta.env.VITE_DOMAIN}/api/applications/${id}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
